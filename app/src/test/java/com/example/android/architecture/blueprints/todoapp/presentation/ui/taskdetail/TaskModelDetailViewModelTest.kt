...
class TaskModelDetailViewModelTest {
    ...
    val task = TaskModel("Title1", "Description1")
    ...
    fun getActiveTaskFromRepositoryAndLoadIntoView() {
        ...
        assertThat(getValue(taskDetailViewModel.taskModel).title).isEqualTo(task.title)
        assertThat(getValue(taskDetailViewModel.taskModel).description)
