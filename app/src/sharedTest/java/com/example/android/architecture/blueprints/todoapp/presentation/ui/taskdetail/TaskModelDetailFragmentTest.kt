...
class TaskModelDetailFragmentTest {
    ...
    fun activeTaskDetails_DisplayedInUi() {
        ...
        val activeTask = TaskModel("Active Task", "AndroidX Rocks", false)
    ...
    fun completedTaskDetails_DisplayedInUi() {
        ...
        val completedTask = TaskModel("Completed Task", "AndroidX Rocks", true)
