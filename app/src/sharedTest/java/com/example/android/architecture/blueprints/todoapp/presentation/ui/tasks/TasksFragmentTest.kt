...
class TasksFragmentTest {
    ...
    fun displayTask_whenRepositoryHasData() {
        ...
        repository.saveTaskBlocking(TaskModel("TITLE1", "DESCRIPTION1"))
    ...
    fun displayCompletedTask() {
        repository.saveTaskBlocking(TaskModel("TITLE1", "DESCRIPTION1", true))
    ...
    fun deleteOneOfTwoTasks() {
        repository.saveTaskBlocking(TaskModel("TITLE1", "DESCRIPTION1"))
        repository.saveTaskBlocking(TaskModel("TITLE2", "DESCRIPTION2"))
    ...
    fun showAllTasks() {
        ...
        repository.saveTaskBlocking(TaskModel("TITLE1", "DESCRIPTION1"))
        repository.saveTaskBlocking(TaskModel("TITLE2", "DESCRIPTION2", true))
    ...
    fun showActiveTasks() {
        ...
        repository.saveTaskBlocking(TaskModel("TITLE1", "DESCRIPTION1"))
        repository.saveTaskBlocking(TaskModel("TITLE2", "DESCRIPTION2"))
        repository.saveTaskBlocking(TaskModel("TITLE3", "DESCRIPTION3", true))
