...
import com.example.android.architecture.blueprints.todoapp.presentation.util.monitorFragment
...
class StatisticsFragmentTest {
    ...
    fun tasks_showsNonEmptyMessage() {
        // Given some tasks
        repository.apply {
            saveTaskBlocking(TaskModel("Title1", "Description1", false))
            saveTaskBlocking(TaskModel("Title2", "Description2", true))
        }
