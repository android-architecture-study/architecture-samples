...
import com.example.android.architecture.blueprints.todoapp.presentation.util.DataBindingIdlingResource
import com.example.android.architecture.blueprints.todoapp.presentation.util.EspressoIdlingResource
import com.example.android.architecture.blueprints.todoapp.presentation.util.deleteAllTasksBlocking
import com.example.android.architecture.blueprints.todoapp.presentation.util.monitorActivity
import com.example.android.architecture.blueprints.todoapp.presentation.util.saveTaskBlocking
...
class TasksActivityTest {
    ...
    @Test
    fun editTask() {
        repository.saveTaskBlocking(TaskModel("TITLE1", "DESCRIPTION"))
    ...
    fun createTwoTasks_deleteOneTask() {
        repository.saveTaskBlocking(TaskModel("TITLE1", "DESCRIPTION"))
        repository.saveTaskBlocking(TaskModel("TITLE2", "DESCRIPTION"))
    ...
    fun markTaskAsCompleteOnDetailScreen_taskIsCompleteInList() {
        ...
        repository.saveTaskBlocking(TaskModel(taskTitle, "DESCRIPTION"))
    ...
    fun markTaskAsActiveOnDetailScreen_taskIsActiveInList() {
        ...
        repository.saveTaskBlocking(TaskModel(taskTitle, "DESCRIPTION", true))
